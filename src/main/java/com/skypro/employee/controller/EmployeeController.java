...
public class EmployeeController {
    ...
    public EmployeeController(EmployeeService employeeService) { //используется принцип инъекции зависимостей
    ...
    public Collection<Employee> getEmployeesWithHighSalary() {
        return this.employeeService.getEmployeesWithHighSalary();
    }
}
